...
import {
  GraduationCap, Globe, Briefcase, ChevronRight, CheckCircle2, Award,
  Smile, Languages, Sliders, Volume2, Sparkles, Activity
} from "lucide-react";
...
const GOALS: GoalCard[] = [
  {
    ...
    subtitle: "Du học & Săn học bổng xuất sắc tại các đại học hàng đầu thế giới thông qua chứng chỉ IELTS / TOEFL Speaking bứt phá.",
  ...
  },
  {
    ...
    subtitle: "Sinh sống và làm việc tại nước ngoài một cách tự tin nhất. Hòa nhập văn hóa bản xứ và giao tiếp mượt mà hằng ngày.",
  ...
  },
  {
    ...
    subtitle: "Tăng thu nhập, làm sếp lớn, đàm phán thành công với đối tác nước ngoài và dẫn dắt các cuộc họp quốc tế thuận lợi.",
...
const DIMENSIONS: DimensionDetail[] = [
  {
    ...
    description: "Nhận diện chính xác từng âm tiết nhỏ nhất (phonemes), phát hiện tức thì các lỗi nuốt âm đuôi và lỗi phát âm sai nguyên âm.",
    details: [
  ...
  },
  {
    ...
    description: "Ngữ điệu là hồn của lời nói. Hệ thống vẽ lại đồ thị cao độ giọng nói của bạn để sửa đổi việc nói đều đều (flat tone) thiếu biểu cảm.",
    details: [
  ...
  },
  {
    ...
    description: "Phân tích tốc độ nói trung bình, nhận diện các khoảng ngập ngừng ngắt quãng bất thường (unnatural hesitations) hay lặp từ.",
    details: [
  ...
  },
  {
    ...
    description: "Quét và chỉnh sửa lỗi ngữ pháp ngay khi nói. Không chỉ phát hiện lỗi mà còn viết lại câu đúng ngữ cảnh, chuyên nghiệp hơn.",
    details: [
  ...
  },
  {
    ...
    metricVal: "Tỷ lệ từ vựng C1/C2 vượt trội",
    description: "Đánh giá mức độ phong phú của từ vựng được sử dụng. Gợi ý thay thế các từ vựng đơn điệu bằng các collocations, idioms học thuật.",
    details: [
...
export default function Features() {
  ...
  return (
    <section id="features-section" className="py-20 bg-[#030014] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-sm sm:text-base max-w-xl mx-auto">
            EngSteps được tối ưu hóa cho mọi lộ trình cá nhân hóa, giúp bạn đạt được bứt phá trong cuộc sống thực tế.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-28">
          {GOALS.map((goal) => (
            ...
            >
              ...
              <a href="#ai-sandbox-section" className="text-xs font-bold text-blue-400 hover:text-blue-300 flex items-center gap-1.5 mt-auto group/link">
                Luyện nói chủ đề này <ChevronRight className="w-4.5 h-4.5 group-hover/link:translate-x-0.5 transition-transform" />
              </a>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div>
              <span className="text-xs font-semibold tracking-widest font-mono text-purple-400 uppercase">CORE TECHNOLOGY</span>
              <h2 className="font-display text-3xl sm:text-4xl font-black text-white tracking-tight mt-1 mb-4">
                5 Chiều Đánh Giá <br />Chuẩn Khảo Thí
              </h2>
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Mỗi câu nói được chia nhỏ để đánh giá đồng thời dưới 5 trục cốt lõi, loại bỏ sự mơ hồ trong việc luyện giao tiếp.
              </p>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-3.5">
                      <div className={`p-2 rounded-lg ${
                        isActive ? "bg-purple-500/20 text-purple-300" : "bg-white/5 text-gray-400"
                      }`}>
                    ...
                    <ChevronRight className={`w-4 h-4 text-gray-500 transition-transform ${isActive ? "translate-x-1 text-purple-400" : ""}`} />
                  </button>
                );
              })}
            </div>
